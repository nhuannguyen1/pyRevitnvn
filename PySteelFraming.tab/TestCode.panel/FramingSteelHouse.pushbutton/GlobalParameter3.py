...
class DataFromCSV:
    ...
    def writefilecsv(self,a):
        ...
        row = [self.Count, self.FamilyCol.Id, self.FamilyColType.Id,self.Base_Level_Col.Id,self.Top_Level_Col.Id,self.FamilyRafter.Id,self.FamilyRafterType.Id,self.LevelRafter.Id,self.Length_Rafter,self.Thinkess_Plate,self.path,self.Gird1,self.Gird2,self.Slope]
        ...
        with open(self.path) as csvFile:
            ...
            for row in readcsv:
                if int(row[0]) == self.Count:
                    ...
                    arr = [self.Count, self.FamilyCol.Id, self.FamilyColType.Id,self.Base_Level_Col.Id,self.Top_Level_Col.Id,\
                        Rafter_Family_Lefted,Rafter_Type_Lefted,self.LevelRafter.Id,Length_Rater_Lefted_n,self.Thinkess_Plate,self.path,self.Gird1,self.Gird2,self.Slope]
        csvFile.close()
        return arr
    def count_csv(self):
