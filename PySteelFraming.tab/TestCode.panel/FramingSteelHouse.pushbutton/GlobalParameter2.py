...
class DataFromCSV:
    ...
    def writefilecsv(self,a):
        ...
        row = [self.Count, self.FamilyCol.Id, self.FamilyColType.Id,self.Base_Level_Col.Id,self.Top_Level_Col.Id,self.FamilyRafter.Id,self.FamilyRafterType.Id,self.LevelRafter.Id,self.Length_Rafter,self.Thinkess_Plate,self.Gird1,self.Gird2,self.Slope]
