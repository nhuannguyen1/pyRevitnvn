...
class Global:
    ...
    def SetParameterInstance (self):
        print ("ParameterValue",self.ParameterValue)
...
def GetParameterFromSubElement (ElementInstance,Rafter_Type_Lefted,Slope,Length_Rafter,path,Gird1,Gird2,Thinkess_Plate):
    ...
    Thinkess_Plate = UnitUtils.ConvertToInternalUnits(float(Thinkess_Plate), DisplayUnitType.DUT_MILLIMETERS)
    ...
    with open(path) as csvFile:
            ...
            for row in readcsv:
                ...
                if row[0]==0:
                    H_n = H_n + Length_Rafter * math.cos(Slope) + Thinkess_Plate * 2
