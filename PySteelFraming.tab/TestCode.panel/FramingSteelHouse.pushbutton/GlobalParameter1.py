...
class ConvertToInternalUnits1:
    ...
    def DUT_DECIMAL_DEGREES1(self):
        ...
        return ParameterValue
def GetParameterFromSubElement (ElementInstance,ParameterName):
    subElements = ElementInstance.GetSubComponentIds()
    for subElement in subElements:
        ele = doc.GetElement(subElement)
        TestParameter = ele.LookupParameter(ParameterName).AsDouble()
